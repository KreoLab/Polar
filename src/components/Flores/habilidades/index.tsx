...
function habilidades() {
    ...
    return (
        <div className="bg-[#FDFBF7] py-20 md:py-32 px-6 lg:px-12">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
                        {pilares.map((pilar, index) => (
                            <div
                                key={index}
                                className="group flex flex-col items-center text-center space-y-6 p-8 rounded-sm hover:shadow-xl hover:shadow-stone-200/50 transition-all duration-500"
                            >
